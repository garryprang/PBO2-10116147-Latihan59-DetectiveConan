 ...
 */
     ...
     */
    public class PBO210116147Latihan59DetectiveConan {

    public static void main(String[] args) {
        //Judul
        System.out.println("KARAKTER-KARAKTER ANIME DETECTIVE CONAN");
        System.out.println("Penulis: Gosho Aoyama");
        System.out.println("Sejak tahun 1994");
        System.out.println();
        ...
        //Sonoko Suzuki
        SonokiSuzuki ss = new SonokiSuzuki("Sonoko Suzuki", "Siswa SMA Teitan", "Kekasih Makoto Kyogoku", "Protagonis", 17, "Perempuan");
